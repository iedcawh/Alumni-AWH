    ...
    <div className="bg-[#0A2A5F] min-h-screen px-6 pt-24 pb-16 text-white font-sans scroll-smooth">
      ...
      <div className="text-center max-w-4xl mx-auto mb-12">
        ...
        <p className="text-white/80 leading-relaxed text-lg max-w-3xl mx-auto">
          Becoming a member of the Alumni Association of AWH Engineering College
          is your first step in continuing the journey you began on this campus.
          It’s more than a formality — it’s a lifelong connection to the people,
          memories, and experiences that shaped who you are today.
        </p>
      </div>
      ...
      <div className="space-y-16">
        ...
        >
          ...
          <p className="text-white/80 leading-relaxed mb-6">
            ...
            College is more than just staying connected — it’s about being part
            of a lifelong community that grows together, gives back, and
          ...
          <ul className="list-disc list-inside space-y-4 text-white/80 text-lg">
            <li>
              ...
              Rekindle memories, stay informed about campus developments, and be
            ...
            <li>
              <span className="font-semibold text-white">Make an Impact:</span>{' '}
            ...
            <li>
              ...
              Support scholarships, campus development initiatives, or volunteer
        ...
        >
          ...
          <p className="text-white/80 text-lg mb-6">
            Anyone who has been a part of AWH Engineering College, Kozhikode and
            shares a bond with the institution is welcome to become a member of
          ...
          <div className="space-y-8 text-white/80 text-lg">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Graduates of any undergraduate or postgraduate program offered
                  by AWH Engineering College.
                </li>
                <li>
                  Former students who have completed at least one full academic
                  year but may not have completed the program due to personal or
                  professional reasons.
                </li>
                <li>
                  Alumni currently pursuing higher studies or employed anywhere
                  in India or abroad.
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  ...
                  served the college and wish to remain connected to the alumni
                  network.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  <span className="font-semibold">Note:</span> Honorary members
                  may be invited by the Executive Committee and may not hold
                  voting rights.
                </li>
              </ul>
            </div>
        ...
        >
          ...
          <p className="text-white/80 text-lg mb-6">
            Becoming a member of the AWH Engineering College Alumni Association
            is not just about staying connected — it’s about opening doors to
            new opportunities, personal growth, and meaningful contributions.
          </p>
          ...
          <div className="space-y-8 text-white/80 text-lg">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Connect with fellow alumni across industries, geographies, and
                  career stages.
                </li>
                <li>
                  Explore job leads, business opportunities, and collaborations
                  through alumni referrals and connections.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Access webinars, industry talks, and expert sessions organized
                  by the association.
                </li>
                <li>
                  Priority invitations to skill development programs, alumni-led
                  training, and career fairs.
                </li>
                <li>
                  Contribute or benefit from job and internship postings shared
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Get featured in the Alumni Spotlight for notable achievements
                  in industry, academia, entrepreneurship, or social service.
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>Use of the library or research resources during visits.</li>
                <li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Enjoy exclusive invites to national and regional alumni meets,
                  reunions, and cultural events.
                </li>
                <li>
                  Meet old friends, faculty members, and relive campus memories.
                </li>
              </ul>
            </div>
        ...
        >
          ...
          <p className="text-white/80 text-lg mb-6">
            Stay connected, stay engaged, and continue to be a proud part of the
            AWH Engineering College alumni community. Renewing your membership
            ensures uninterrupted access to all the benefits and opportunities
            offered by the Alumni Association — and helps us stay updated with
            your latest contact, career, and location details.
          </p>
          ...
          <ul className="list-disc list-inside text-white/80 text-lg space-y-2 mb-6">
            <li>
              Membership is valid for a fixed term: 1 year, 3 years, or 5 years
            </li>
            <li>
            ...
            <li>
              Members are encouraged to renew in time to ensure seamless access
              to alumni activities and communications
            </li>
          </ul>
          ...
          <p className="text-white/80 text-lg mb-4">
            If you need assistance with the renewal process, feel free to reach
            out:
          </p>
          <p className="text-white/80 text-lg">
            ...
            <br />
            <strong>Support Hours:</strong> 9:00 AM – 4:30 PM (Monday to Friday)
          </p>
        ...
        >
          ...
          <p className="text-white/80 text-lg mb-6">
            Have questions? Check out our FAQs or reach out to the alumni office
            for support.
          </p>
          ...
          <div className="space-y-6 text-white/80 text-lg">
            ...
            <div>
              ...
              <p>
                You can apply by filling out the Online Membership Registration
                Form available on the website. After submitting the form and
                completing the payment, you&#39;ll receive a confirmation email
            ...
            <div>
              ...
              <p>
                No. A nominal membership fee is applicable based on the type and
                duration of the membership (1 year, 3 years, or 5 years). The
                fee helps the association organize activities, events, and
            ...
            <div>
              ...
              <p>
                ...
                ensures your profile information is current. It also enables you
                to continue enjoying the benefits such as event invitations,
                newsletters, voting rights, and networking access.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                office via email. For profile updates, please fill in the latest
                information during renewal or write to us with your updated
                details.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Yes. Once you successfully register or renew, you will receive a
                confirmation email along with your Membership ID.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Some events are open to all alumni, but many programs, including
                reunions, career webinars, and elections, are exclusive to
                registered members.
              </p>
            </div>
